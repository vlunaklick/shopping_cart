...
export default function Checkout(props){
    ...
    let tarjetasCheck = (allComponents.filter(item => { 
        return props.productos[item.nameU] !== 0
    })).map(item => {
        return <TargetCheck key={item.nameU} nameU={item.nameU} image={item.image} cantiT={props.productos[item.nameU]} sumar={props.sumar} restar={props.restar} />
    })
...
let allComponents = [
    ...
    },
    {
        ...
        price: 90,
        category: "video_card",
        image: "https://static.gigabyte.com/StaticFile/Image/Global/d7cd9f37fc1eaa31ba619f1254fbbd78/Product/19596/png/1000",
    },
    {
